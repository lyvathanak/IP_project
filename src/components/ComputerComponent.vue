    ...
    async fetchProducts() {
      try {
        const [
          ...
          axios.get("http://localhost:5000/speaker"),
          axios.get("http://localhost:5000/controller"),
          axios.get("http://localhost:5000/power-supply-unit"),
          axios.get("http://localhost:5000/mouse"),
          axios.get("http://localhost:5000/keyboard"),
          axios.get("http://localhost:5000/usb"),
          axios.get("http://localhost:5000/microphone"),
          axios.get("http://localhost:5000/cooling-fans"),
          axios.get("http://localhost:5000/bluetooth-adapter"),
          axios.get("http://localhost:5000/msi"),
          axios.get("http://localhost:5000/asus"),
          axios.get("http://localhost:5000/apple"),
          axios.get("http://localhost:5000/hp"),
          axios.get("http://localhost:5000/lenovo"),
          axios.get("http://localhost:5000/acer"),
          axios.get("http://localhost:5000/hdd"),
          axios.get("http://localhost:5000/ssd"),
          axios.get("http://localhost:5000/nvme-drives"),
          axios.get("http://localhost:5000/external-hard-drivers"),
          axios.get("http://localhost:5000/memory-cards"),
          axios.get("http://localhost:5000/usb-flash-drivers"),
          axios.get("http://localhost:5000/cloud-storage"),
          axios.get("http://localhost:5000/raid-systems"),
          axios.get("http://localhost:5000/nas"),
          axios.get("http://localhost:5000/accessories"),
          axios.get("http://localhost:5000/laptops-bages"),
          axios.get("http://localhost:5000/gaming-headsets"),
          axios.get("http://localhost:5000/external-dvd-drivers"),
          axios.get("http://localhost:5000/docking-stations"),
          axios.get("http://localhost:5000/external-keyboard"),
          axios.get("http://localhost:5000/mouse-pads"),
          axios.get("http://localhost:5000/cable-organizer"),
          axios.get("http://localhost:5000/power-bank"),
          axios.get("http://localhost:5000/screen-protector"),
          axios.get("http://localhost:5000/webcams"),
          axios.get("http://localhost:5000/usb-hubs"),
          axios.get("http://localhost:5000/adapters-and-converters"),
        ]);
